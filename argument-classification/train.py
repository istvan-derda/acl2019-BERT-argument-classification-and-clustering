...
def convert_examples_to_features(examples, label_list, max_seq_length, tokenizer):
    ...
    for (ex_index, example) in enumerate(examples):
        feature, is_token_a_longer_max_seq_length = convert_example_to_feature(ex_index, example, max_seq_length,
                                                                               tokenizer, label_map)
        features.append(feature)
        tokens_a_longer_max_seq_length += is_token_a_longer_max_seq_length
...
def convert_example_to_feature(ex_index, example, max_seq_length, tokenizer, label_map):
    ...
    token_a_longer_max_seq_length = 0
    if (len_tokens_a + len_tokens_b) > (max_seq_length - 2):
        token_a_longer_max_seq_length = 1
